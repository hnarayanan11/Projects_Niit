...
//to create beans
	...
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{Product.class,Supplier.class,Category.class,Customer.class,User.class,Authorities.class,BillingAddress.class,ShippingAddress.class};
